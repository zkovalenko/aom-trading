      ...
      <div className="container">
        ...
        <div className="service-intro">
          ...
          <div className="service-description">
            ...
            <p>
              Join our intensive 8-week group bootcamp designed to fast-track your trading career. Learn alongside other motivated traders in a structured, comprehensive program that covers everything from basics to advanced strategies.
            </p>
        ...
        <div className="service-details">
          <div className="program-overview">
            ...
            <div className="overview-content">
              <div className="overview-text">
                <p>
                  Our Trading Bootcamp is an intensive 8-week program that transforms complete beginners into competent traders. 
          ...
          <div className="curriculum">
            ...
            <div className="curriculum-grid">
              <div className="week-item">
                <div className="week-number">Week 1-2</div>
              ...
              <div className="week-item">
                <div className="week-number">Week 3-4</div>
              ...
              <div className="week-item">
                <div className="week-number">Week 5-6</div>
              ...
              <div className="week-item">
                <div className="week-number">Week 7-8</div>
          ...
          <div className="bootcamp-features">
            ...
            <div className="features-grid">
              ...
              <div className="feature-item">
                ...
                <p>6 months of post-graduation mentorship and access to exclusive trading community.</p>
              </div>
            </div>
          </div>
            ...
            <div className="schedule-content">
              <div className="schedule-details">
                ...
                <div className="schedule-item">
                  ...
                  <p>Saturday practice sessions and market reviews</p>
                </div>
                <div className="schedule-item">
                  <h4>Evening Support</h4>
                  <p>Daily Q&A sessions from 6:00 PM - 7:00 PM EST</p>
                </div>
                <div className="schedule-item">
                  <h4>Format</h4>
              ...
              <div className="next-cohorts">
                ...
                <div className="cohort-item">
                  <div className="cohort-date">March 15, 2024</div>
                  <div className="cohort-status available">6 spots available</div>
                </div>
                <div className="cohort-item">
                  <div className="cohort-date">May 10, 2024</div>
                  <div className="cohort-status available">8 spots available</div>
                </div>
                <div className="cohort-item">
                  <div className="cohort-date">July 22, 2024</div>
          ...
          <div className="pricing-section">
            <div className="pricing-info">
              <h3>Bootcamp Investment</h3>
              <div className="bootcamp-pricing">
                <div className="price-main">$8,500</div>
                <div className="price-details">
                  ...
                  <div className="payment-options">
                    <div className="payment-option">
                      <strong>Full Payment:</strong> $8,500 (save $500)
                    </div>
                    <div className="payment-option">
